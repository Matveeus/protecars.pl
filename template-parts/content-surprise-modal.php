...
<div id="surprise_modal" class="modal-window">
    <div class="modal-container">
        <div class="modal_window_main_page">
            ...
            <div class="tada-image-main-page"></div>
            <h1 class="modal-title-main-page">Znalazłeś Wielkanoc!</h1>
            <p class="modal-text-main-page">Wpisz kod promocyjny <span class="purple-text">Protecars2022</span> w koszyku i otrzymasz zniżkę 5% </p>
        </div>
    </div>
</div>
